...
data = np.load('/Users/llicht/Documents/csc475_asn3_data.tar.gz')
a = data['arr_0']
a[a > 0] = 1
labels = np.load('/Users/fly/Documents/csc475_asn3_data/labels.npz')
labels = labels['arr_0']
dictionary = pickle.load(open('/Users/fly/Documents/csc475_asn3_data/dictionary.pck','rb'), encoding='latin1')
